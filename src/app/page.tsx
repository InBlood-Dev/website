...
const WHATSAPP_URL = "https://whatsapp.com/channel/0029VbCiUaNJf05WMHQji23u";
const TELEGRAM_URL = "https://t.me/+byN-nnS76SVmM2I1";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden relative">
      ...
      <section ref={heroRef} className="relative z-[1] min-h-[100svh] flex flex-col justify-center pt-20 pb-8 md:pb-12 px-8 md:px-16 overflow-hidden">
        {/* Background Video */}
        <video
          autoPlay
          muted
        ...
        <div className="max-w-[1400px] mx-auto w-full z-10 flex flex-col items-center text-center gap-12 max-md:flex-1">
          ...
          <div className="flex items-center gap-5 max-md:flex-1">
            ...
            <h1 className="text-2xl font-light whitespace-nowrap">
              <span className="text-white/90">Welcome to</span> <span className="laser-text font-medium">Adult</span> <span className="text-white/90">Community</span>
            </h1>
            <span className="h-px w-10 md:w-16 bg-gradient-to-l from-transparent to-white/40" />
          </div>

          {/* Primary CTA */}
          <a href={PLAY_STORE_URL} target="_blank" rel="noopener noreferrer" className="laser-btn group flex items-center justify-center gap-2 md:gap-3 px-5 py-3.5 md:px-10 md:py-6 text-xs md:text-base font-bold rounded-xl md:rounded-2xl uppercase tracking-[0.12em] md:tracking-[0.15em] bg-black border border-primary/40 text-primary hover:border-primary hover:shadow-[0_0_40px_rgba(220,38,38,0.5)] transition-all duration-300 overflow-hidden md:min-w-[360px] whitespace-nowrap">
            <svg className="w-5 h-5 md:w-6 md:h-6 relative z-10" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
              <path fill="#32BBFF" d="M3.999,4.793C3.477,5.342,3.171,6.196,3.171,7.302v33.396c0,1.106,0.305,1.96,0.828,2.509l0.111,0.108L23.034,24.22v-0.44L4.111,4.685L3.999,4.793z"/>
              <path fill="#FFD500" d="M29.336,30.522l-6.302-6.302v-0.44l6.303-6.303l0.142,0.081l7.466,4.243c2.132,1.211,2.132,3.193,0,4.405l-7.466,4.236L29.336,30.522z"/>
              <path fill="#FF3333" d="M29.478,30.441L23.034,24L3.999,43.207c0.703,0.744,1.864,0.836,3.171,0.094L29.478,30.441z"/>
              <path fill="#00C853" d="M29.478,17.559L7.171,4.699C5.864,3.957,4.703,4.049,3.999,4.793L23.034,24L29.478,17.559z"/>
          ...
          <div className="relative rounded-3xl bg-gradient-to-b from-white/[0.04] to-white/[0.01] border border-white/10 backdrop-blur-xl p-8 md:p-10 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.6)]">
            ...
            <div data-hero-line className="flex justify-center">
              <a
                ...
                className="group flex items-center gap-3.5 w-full rounded-2xl px-5 py-4 bg-[#26A5E4]/10 border border-[#26A5E4]/30 hover:bg-[#26A5E4]/20 hover:border-[#26A5E4]/60 hover:-translate-y-0.5 transition-all duration-300"
              >
                <div className="relative w-11 h-11 rounded-xl flex items-center justify-center bg-[#26A5E4] shrink-0 transition-transform duration-300 group-hover:scale-110">
                  <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor"><path d={TELEGRAM_PATH} /></svg>
                </div>
                <div className="flex-1 text-left">
                  <p className="text-white text-sm font-semibold group-hover:text-white transition-colors">Join our Telegram Channel</p>
                  <p className="text-white/40 text-xs mt-0.5">Connect with the inBlood community</p>
                </div>
                <svg className="w-4 h-4 text-white/30 group-hover:text-white/70 group-hover:translate-x-0.5 transition-all shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7"/></svg>
              </a>
            </div>
          </div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-24 right-6 z-50 w-14 h-14 rounded-full bg-[#26A5E4] flex items-center justify-center shadow-lg shadow-[#26A5E4]/30 hover:scale-110 hover:shadow-xl hover:shadow-[#26A5E4]/40"
        style={{
          ...
          transition: heroInView
            ? "transform 500ms ease-out 80ms, opacity 500ms ease-out 80ms, visibility 0s linear 0s"
